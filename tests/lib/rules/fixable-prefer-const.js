...
ruleTester.run("fixable-prefer-const", rule, {
  valid: [
    ...
    { code: "let [x = -1, y] = [1,2]; y = 0;", ecmaFeatures: { blockBindings: true, destructuring: true } },
    { code: "let {a: x = -1, b: y} = {a:1,b:2}; y = 0;", ecmaFeatures: { blockBindings: true, destructuring: true } },
    { code: "(function() { let [x = -1, y] = [1,2]; y = 0; })();", ecmaFeatures: { blockBindings: true, destructuring: true } },
    { code: "(function() { let {a: x = -1, b: y} = {a:1,b:2}; y = 0; })();", ecmaFeatures: { blockBindings: true, destructuring: true } }
  ],
  invalid: [
    {
      code: "let x = 1; foo(x);",
